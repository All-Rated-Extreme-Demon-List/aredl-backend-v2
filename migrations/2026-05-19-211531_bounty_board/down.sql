...
DROP TABLE aredl.bounty_completed;
DROP TABLE aredl.bounties;

DROP TABLE arepl.bounty_completed;
DROP TABLE arepl.bounties;

DROP TYPE bounty_type;
DROP TYPE bounty_difficulty;