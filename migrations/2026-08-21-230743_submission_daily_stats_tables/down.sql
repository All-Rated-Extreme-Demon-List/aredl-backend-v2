DROP TRIGGER IF EXISTS submission_daily_stats_ins ON aredl.submissions;
DROP TRIGGER IF EXISTS submission_daily_stats_upd ON aredl.submissions;

DROP TRIGGER IF EXISTS submission_daily_stats_ins ON arepl.submissions;
DROP TRIGGER IF EXISTS submission_daily_stats_upd ON arepl.submissions;

DROP FUNCTION IF EXISTS aredl.rebuild_submission_daily_stats();
DROP FUNCTION IF EXISTS arepl.rebuild_submission_daily_stats();

DROP FUNCTION IF EXISTS aredl.update_submission_daily_stats_from_submission();
DROP FUNCTION IF EXISTS arepl.update_submission_daily_stats_from_submission();

DROP FUNCTION IF EXISTS aredl.apply_submission_daily_stats_diff(
    date,
    uuid,
    uuid,
    bigint,
...
DROP FUNCTION IF EXISTS arepl.apply_submission_daily_stats_diff(
    date,
    uuid,
    uuid,
    bigint,
...
DROP TABLE IF EXISTS aredl.submission_daily_level_stats;
DROP TABLE IF EXISTS aredl.submission_daily_reviewer_stats;
DROP TABLE IF EXISTS aredl.submission_daily_total_stats;

DROP TABLE IF EXISTS arepl.submission_daily_level_stats;
DROP TABLE IF EXISTS arepl.submission_daily_reviewer_stats;
DROP TABLE IF EXISTS arepl.submission_daily_total_stats;
