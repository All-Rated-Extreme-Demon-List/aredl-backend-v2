ALTER TABLE aredl.level_ldms RENAME TO level_custom_copies;
ALTER TABLE aredl.level_custom_copies RENAME COLUMN ldm_id TO copy_id;

ALTER TABLE arepl.level_ldms RENAME TO level_custom_copies;
ALTER TABLE arepl.level_custom_copies RENAME COLUMN ldm_id TO copy_id;

ALTER TABLE aredl.submissions RENAME COLUMN ldm_id TO custom_copy_id;
ALTER TABLE arepl.submissions RENAME COLUMN ldm_id TO custom_copy_id;

ALTER TABLE aredl.submission_history RENAME COLUMN ldm_id TO custom_copy_id;
ALTER TABLE arepl.submission_history RENAME COLUMN ldm_id TO custom_copy_id;
