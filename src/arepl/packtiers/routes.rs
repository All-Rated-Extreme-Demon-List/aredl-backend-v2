...
use crate::arepl::packtiers::PackTierResolved;
...
#[get(
    "",
    wrap = "UserAuth::load()",
    wrap = "CacheController::auth_public_with_max_age(3600)"
)]
async fn find_all(
...
#[openapi(
    tags(
        (name = "AREDL (P) - Pack Tiers", description = "Endpoints to fetch and manage AREDL platformer pack tiers")
    ),
    components(
        schemas(
            PackTier,
