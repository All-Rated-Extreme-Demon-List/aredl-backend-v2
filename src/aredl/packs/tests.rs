...
use {
    crate::{
        aredl::{
            levels::test_utils::{add_test_level_to_pack, create_test_level},
            packs::test_utils::{create_test_pack, create_test_pack_tier},
...
async fn get_pack_victors_returns_pack_victors_in_completion_order() {
    ...
    let req = test::TestRequest::get()
        .uri(&format!("/aredl/packs/{pack_id}/victors"))
        .to_request();
