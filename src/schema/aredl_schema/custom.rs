...
diesel::table! {
    aredl.user_leaderboard (user_id) {
        rank -> Int4,
        raw_rank -> Int4,
        extremes_rank -> Int4,
        country_rank -> Int4,
...
diesel::table! {
    aredl.country_leaderboard (country) {
        rank -> Int4,
        extremes_rank -> Int4,
        country -> Int4,
        level_points -> Int4,
...
diesel::table! {
    aredl.country_member_points (country, submitted_by) {
        country -> Int4,
        submitted_by -> Uuid,
...
diesel::table! {
    aredl.clans_leaderboard (clan_id) {
        rank -> Int4,
        extremes_rank -> Int4,
        clan_id -> Uuid,
        level_points -> Int4,
...
diesel::table! {
    aredl.clan_member_points (clan_id, submitted_by) {
        clan_id -> Uuid,
        submitted_by -> Uuid,
        completed_levels -> Int8,
        contributed_points -> Float8,
