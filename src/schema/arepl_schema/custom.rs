...
diesel::table! {
    arepl.badge_level_statistics (submitted_by, id) {
        submitted_by -> Uuid,
        id -> Uuid,
        name -> Varchar,
        position -> Nullable<Int4>,
...
diesel::table! {
    arepl.country_created_levels (country, level_id, creator_id) {
        country -> Int4,
        level_id -> Uuid,
        creator_id -> Uuid,
...
diesel::table! {
    arepl.clans_created_levels (clan_id, level_id, creator_id) {
        clan_id -> Uuid,
        level_id -> Uuid,
        creator_id -> Uuid,
        order_pos -> Nullable<Int4>,
